<div class="grid_6">
  <div class="pad_box3 separate">
    <h3 class="pink1 ind bg_none"><?php echo $text_your_details; ?></h3>
...
<div class="grid_6">
  <div class="pad_box4">
  <h3 class="pink1 ind bg_none"><?php echo $text_your_address; ?></h3>
...
$('#payment-address select[name=\'country_id\']').bind('change', function() {
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/kids/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			
